...
import AppleIcon from '../../../public/herosection.png';
import MainImage from '../../../public/herosection2.png';
    ...
    <div className="w-[75%] mx-auto md:flex ">
      ...
      <div className="bg-black mt-8 md:ml-8 md:w-[72%] w-[100%] md:flex relative hover:z-20">
        <div className="flex flex-col">
         <Image src={AppleIcon} alt="hero section image" width={500} height={500} className="w-[180px] md:ml-5 lg:mt-[-15px] mt-[-35px] md:mt-[-40px]" />
        ...
        <div className="max-w-[100%] h-auto md:flex md:justify-center md:items-center lg:mb-7">
            <Image src={MainImage} alt="mobile" />
        </div>
